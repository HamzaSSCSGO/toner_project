				...
				<div class="card">
					<div class="card-header pb-0">
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{route('update.toner',$toner->id)}}" enctype="multipart/form-data" >
                                @csrf 
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control digits" type="number" value={{$toner->quantity_left}} placeholder="Quantity" name="quantity"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img height="100px" width="auto" src="{{asset('storage/storage/toner/' .$toner->toner_image)}}">
                                                </div>
                                            </div>
