				...
				<div class="card">
					<div class="card-header pb-0">
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{route('update.printer',$printer->id)}}" enctype="multipart/form-data" >
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value={{$printer->printer_name}} class="form-control" name="printer_name" type="text" placeholder="write the printer's name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value={{$printer->serial_number}} class="form-control" name="serialNumber" type="text" placeholder="write the serial number" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value={{$printer->ip}} class="form-control" name="ip" type="text" placeholder="Write the IP address" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <img height="50px" src="{{asset('storage/storage/printer/'.$printer->printer_image)}}">
                                                </div>
                                            </div>
