				...
				<div class="card">
					<div class="card-header pb-0">
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{route('test.testcontroller')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control digits" name="start_date" type="date" {{-- value="2018-01-01" --}} />
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label class="col-sm-3 col-form-label">End Date</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control digits" name="end_date" type="date" {{-- value="2018-01-01" --}} />
                                                </div>
                                            </div>
                                            {{-- <div class="mb-3 row">
