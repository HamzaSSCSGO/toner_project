                                ...
                                <tr>
                                    <td>
                                        <table style="width: 650px; margin: 0 auto; margin-bottom: 30px;">
                                            <tbody>
                                                <tr>
                                                    <td><img style="height:30px; width:auto;" src="{{ asset('assets/images/logo/tam.png') }}" alt="" /></td>
                                                    <td style="text-align: right; color: #999;"><span>{{-- {{$details['description']}} --}}Critical stock</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                            ...
                                                            <div class="col-sm-12 col-lg-12 col-xl-12">
                                                                <div class="table-responsive"> --}}
                                                                    <table class="data-table">
                                                                        <thead class="table-border" {{-- class="bg-primary" --}} style="padding: 10px; background-color: #24695c; color: #ffffff;">
                                                                            {{-- <tr>
                                                                        ...
                                                                        <tbody>
                                                                            @foreach($details['toners'] as $detail)
                                    
                                                                            {{-- {{dd($toner)}} --}}
                                                                            
                                                                                <tr  class="table-border">
                                                                                    <td  class="table-border">{{$detail->toners_id}}</td>
                                                                                    <td  class="table-border"><img height="100px" width="auto" src="{{$message->embed(public_path('storage\storage\toner\\').  $detail->toner_image)}}"></td>
                                                                                    <td  class="table-border">{{$detail->toner_model_name}}</td>
                                                                                    <td  class="table-border">{{ $detail->color_name }}</td>
                                    
                                                                                    
                                                                                    <td  class="table-border"> {{$detail->quantity_left}}</td> 
