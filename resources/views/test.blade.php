                                                            ...
                                                            <div class="col-sm-12 col-lg-12 col-xl-12">
                                                                <div class="table-responsive"> --}}
                                                                    <table class="data-table">
                                                                        <thead {{-- class="bg-primary" --}} style="padding: 10px; background-color: #24695c; color: #ffffff;">
                                                                            {{-- <tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            {{-- {{dd($toner)}} --}}
                                                                                ...
                                                                                <tr>
                                                                                    {{-- <td>{{$detail->toners_id}}</td>
                                                                                    <td><img height="100px" width="auto" src="{{attach($detail->toner_image)}}"></td> --}}
                                                                                    <td>{{$detail->toner_model_name}}</td>
                                                                                    <td>{{ $detail->color_name/* $toner['color_id'] */ }}</td>
